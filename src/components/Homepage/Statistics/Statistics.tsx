	...
	return (
		<section className="section bg-[#040E36]">
			<div className="container">
				<div className="stats-card-wrapper stats-desktop-structure">
					<div className="stats-card-row flex items-start">
						<div className="stats-card stats-card-1 w-[409px]">
							<h2 className="font-semibold text-[white] ">Impact</h2>
							<p className="font-normal text-18 text-[white] mt-[20px] w-[349px]">Behind every number is a promise we&apos;ve kept.
					...
					<div className="stats-card-row flex items-end border-t border-[#424242]">
				...
				<div className="stats-tablet-structure">
					<div className="stats-tablet-card-row stats-tablet-card-row-1 flex">
						<div className="stats-card stats-card-1 w-[409px]">
							<h2 className="font-semibold text-[white] ">Impact</h2>
							<p className="font-normal text-18 text-[white] mt-[20px] w-[349px]">Behind every number is a promise we&apos;ve kept.
								From long-term partnerships to measurable outcomes, these milestones reflect the trust we&apos;ve earned and the impact we&apos;ve created.
					...
					<div className="stats-tablet-card-row stats-tablet-card-row-2 flex">
						<div className="stats-card stats-card-3 w-[397px] h-[428px] p-[20px] border-l border-[#424242]">
							<h3 className="font-semibold text-[white] mb-[6px] font-[64px]">8+</h3>
							<p className="stats-subtitle font-normal text-18 text-[white] uppercase">Industries Transformed Globally</p>
							<div className="stast-card-image rounded-[20] w-[357px] h-[200] mt-[20px] mb-[20px] border border border-[#021357]">
