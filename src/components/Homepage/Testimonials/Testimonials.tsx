	...
	return (
		<section className='section'>
			<div className="container">
				...
				<div className="hm-testimonial-wrapper flex justify-between">
					<div className="w-[690px] h-[508px] bg-[#fbf8f5] rounded-[20px]"></div>

					<div className="testimonial-swiper w-[870px]">
						<Swiper
							slidesPerView={2}
							spaceBetween={20}
						>
							<SwiperSlide className="testimonial-swiper ">
								<div className="w-[420] h-[464]">
									<div className="testimonial-client-review p-[20px] bg-[#F5F8F5] rounded-[20px]">
										...
										<div className="client-review-stars mt-[14px] flex gap-[2px]">
											<Image src={`${CDN_URL}/images/homepage/testimonialvideos/testimonial-star.svg`} alt="header-logo" width={24} height={24} priority />
											<Image src={`${CDN_URL}/images/homepage/testimonialvideos/testimonial-star.svg`} alt="header-logo" width={24} height={24} priority />
											<Image src={`${CDN_URL}/images/homepage/testimonialvideos/testimonial-star.svg`} alt="header-logo" width={24} height={24} priority />
											<Image src={`${CDN_URL}/images/homepage/testimonialvideos/testimonial-star.svg`} alt="header-logo" width={24} height={24} priority />
											<Image src={`${CDN_URL}/images/homepage/testimonialvideos/testimonial-star.svg`} alt="header-logo" width={24} height={24} priority />
